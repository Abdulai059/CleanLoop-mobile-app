  ...
  return (
    <View className="flex-row justify-between px-4 mt-2">
      ...
      <TouchableOpacity
        ...
        className="bg-white px-8 py-3.5 rounded-2xl shadow-sm shadow-slate-200 border border-slate-100 flex-1 mx-1.5 items-center justify-center active:opacity-80"
      >
